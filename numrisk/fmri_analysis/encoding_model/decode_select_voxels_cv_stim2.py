...
def main(subject, smoothed, pca_confounds, bids_folder='/data',
    ...
    data = sub.get_single_trial_volume(session, n_stim=n_stim, roi=mask,smoothed=smoothed, pca_confounds=pca_confounds, denoise=denoise, retroicor=retroicor).astype(np.float32)
